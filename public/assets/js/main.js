...
jQuery(document).on("ready", function () {
    ...
    function collapseMenu() {
        jQuery('.tg-navigation ul li.menu-item-has-children, .tg-navdashboard ul li.menu-item-has-children, .tg-navigation ul li.menu-item-has-mega-menu').each(function() {
            // Remove the dropdown arrow
            jQuery(this).find('.tg-dropdowarrow').remove();
            // Add the dropdown arrow back only to the first submenu item
            jQuery(this).children('.sub-menu').children('.menu-item-has-children, .menu-item-has-mega-menu').first().prepend('<span class="tg-dropdowarrow"><i class="fa fa-angle-down"></i></span>');
          });
        jQuery(
            ".tg-navigation ul li.menu-item-has-children span, .tg-navdashboard ul li.menu-item-has-children a, .tg-navigation ul li.menu-item-has-mega-menu span"
        ).on("click", function () {
            jQuery(this).parent("li").toggleClass("tg-open");
            jQuery(this).next().slideToggle(300);
        });

        jQuery(".tg-navdashboard ul li.menu-item-has-children span").on(
            "click",
            function () {
                jQuery(this).parent("li").toggleClass("tg-open");
    ...
    if (jQuery("#tg-productrangeslider").length > 0) {
        jQuery("#tg-productrangeslider").slider({
            ...
            slide: function (event, ui) {
                jQuery("#tg-productrangeamount").val(
                    ui.values[0] + "km" + " - " + ui.values[1] + "km"
                );
            },
        });
        jQuery("#tg-productrangeamount").val(
            jQuery("#tg-productrangeslider").slider("values", 0) +
                "km" +
                " - " +
                jQuery("#tg-productrangeslider").slider("values", 1) +
                "km"
        );
    }
    /*--------------------------------------
    ...
    if (jQuery("#tg-safetytipsslider").length > 0) {
        ...
        _tg_safetytipsslider.on("changed.owl.carousel", function (event) {
            ...
            jQuery(".tg-currentandtotalslides").html(
                "0" + item + " / 0" + items + ""
            );
        });
    ...
    if (jQuery(".tg-horizontalthemescrollbar").length > 0) {
        var _tg_horizontalthemescrollbar = jQuery(
            ".tg-horizontalthemescrollbar"
        );
    ...
    if (jQuery("#tg-checkedall").length > 0) {
        ...
        jQuery("#tg-checkedall").on("change", function () {
            //"select all" change
            jQuery(".tg-checkbox > input[type=checkbox]").prop(
                "checked",
        ...
        jQuery(".checkbox").on("change", function () {
            ...
            if (
                jQuery(".tg-checkbox > input[type=checkbox]:checked").length ==
                jQuery(".tg-checkbox > input[type=checkbox]").length
            ) {
    ...
    if (jQuery("#tg-adstype").length > 0) {
        ...
        _clickedValue.on("click", function (event) {
            ...
            jQuery(
                '#tg-adstype tr[data-category="' + _datacategory + '"]'
            ).fadeIn();
    ...
    if (jQuery("#tg-pkgexpirycounter").length > 0) {
        ...
        var x = setInterval(function () {
            ...
            document.getElementById("tg-pkgexpirycounter").innerHTML =
                "<ul><li><div class='tg-holder'><h3>" +
                days +
                "</h3><h4>Days</h4></div></li><li><div class='tg-holder'><h3>" +
                hours +
                "</h3><h4>Hours</h4></div></li><li><div class='tg-holder'><h3>" +
                minutes +
                "</h3><h4>Minutes</h4></div></li><li><div class='tg-holder'><h3>" +
                seconds +
                "</h3><h4>Seconds</h4></div></li></ul>";
    ...
    if (jQuery("#tg-comingsooncounter").length > 0) {
        ...
        var x = setInterval(function () {
            ...
            var seconds = Math.floor((distance % (1000 * 60)) / 1000);
            // Output the result in an element with id="demo"
            document.getElementById("tg-comingsooncounter").innerHTML =
                "<ul><li><div class='tg-holder'><h3>" +
                days +
                "</h3><h4>Days</h4></div></li><li><div class='tg-holder'><h3>" +
                hours +
