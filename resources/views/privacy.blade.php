...
<body class="tg-comingsoonpage">
                        ...
                        <div id="tg-content" class="tg-content">
                            <div class="tg-comingsooncontent">
                                <div class="tg-logobox">
                                    <strong class="tg-logo"><a href="javascript:void(0);"><img src="{{ asset('https://res.cloudinary.com/dxkd6xlpq/image/upload/c_scale,q_auto:best,w_200/v1677214607/logos/logo%20text/Black_Shifft_Text_Cropped.png') }}" alt="image description"></a></strong>
                                </div>
                                <!-- <div id="tg-comingsooncounter" class="tg-comingsooncounter"></div> -->
                                <div class="tg-textbox">
                                    <h5>Privacy Policy<span></span></h5>
                                ...
                                <span class="tg-copyright">2023 All Rights Reserved © Shifft</span>
                            </div>
                        </div>
                    </div>
                </div>
	...
	*************************************-->
    ...
    <script>
        // $.backstretch(["images/slider/img-02.jpg"]);
    </script>
</body>
