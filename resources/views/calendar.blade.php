                                    ...
                                    <div class="tg-widgetcontent">
                                        <form class="tg-formtheme tg-formsearch" action="{{ route('events.calendar') }}"
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="form-group">
                                                    <label for="subscribed" class="inline-flex items-center">
                                                        <input id="subscribed" type="checkbox"
                                                            class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                                            name="subscribed" value="true" {{ $filter['subscribed'] ? 'checked' : '' }}>
                                                        <span class="ml-2 text-sm text-gray-600">Subscribed events only</span>
                                                    </label>
                                                </div>

                                                <div class="form-group">
                                                    <label for="all" class="inline-flex items-center">
                                                        <input id="all" type="checkbox"
                                                            class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                                            name="all" value="true" {{ $filter['all'] ? 'checked' : '' }}>
                                                        <span class="ml-2 text-sm text-gray-600">All events</span>
                                                    </label>
                                                </div>
